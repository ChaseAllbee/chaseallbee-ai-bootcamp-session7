...
CI must validate a Node.js 20 full-stack app (Express backend and React frontend), run automated tests with Jest (including coverage enforcement), and verify infrastructure changes built with Terraform (AWS provider) for the dev stack.
